...
CREATE TABLE `t_chat_message`  (
  ...
  `is_like` int(4) NULL DEFAULT 0 COMMENT '是否点赞（0，1喜欢，2不喜欢）',
  `word_count` bigint(20) NULL DEFAULT 0 COMMENT '字数统计',
  `tokens` bigint(20) NULL DEFAULT 0 COMMENT 'Token使用量',
  `model_version_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模型版本ID',
  `model_version_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '模型版本名称',
...
-- ----------------------------
INSERT INTO `t_chat_message` VALUES ('0255c9dc272b3e83708ecb1b2d6b38e8', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '请使用Java帮我写一个冒泡排序算法', 0, 18, 0, NULL, NULL, '2024-04-24 16:28:05');
INSERT INTO `t_chat_message` VALUES ('0463447007d5f34be680dca594a2f4ae', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '写段代码', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:42:50');
INSERT INTO `t_chat_message` VALUES ('048125b0b68fd3aa154e52604e3cadb0', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', 0, 2, 0, NULL, NULL, '2024-04-24 16:08:02');
INSERT INTO `t_chat_message` VALUES ('0527ca3f9cacc96c788a7b12621e3c78', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '46bdb8a4383c214a4eaa674f8eba4863', ' 你好，我是一款AI，专门设计来回答问题和提供帮助的。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:29:18');
INSERT INTO `t_chat_message` VALUES ('058228c7819d9d48cace5712914efd66', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:54:14');
INSERT INTO `t_chat_message` VALUES ('0b7d519342cb58885ddf8fee12fcd448', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', '733a3c1b14fafb9bf906af76f57aaea9', ' 你好！有什么我可以帮助你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:50:12');
INSERT INTO `t_chat_message` VALUES ('0d98a0da607f985ebf154773b10b91c2', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你是谁？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:00:48');
INSERT INTO `t_chat_message` VALUES ('1133a51b69c881f13129e3a9ba8d2a79', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:05');
INSERT INTO `t_chat_message` VALUES ('11403c3dd67818863e9203300ce5a29c', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '154401ea0b86ff6bd64342b446f7ae9d', ' 我是一款智能聊天机器人，旨在帮助和回答各种问题。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:42:26');
INSERT INTO `t_chat_message` VALUES ('1471a4fb6fffc28825161e6e8983d51d', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', 0, 2, 0, NULL, NULL, '2024-04-24 17:57:18');
INSERT INTO `t_chat_message` VALUES ('154401ea0b86ff6bd64342b446f7ae9d', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:42:26');
INSERT INTO `t_chat_message` VALUES ('15cc2f4464a80051c72e8c84bb5ab99e', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'b833e060a910cc63b4afec749970b014', ' 当然，这里是一段代码，它将提示用户输入一个字符串并返回该字符串的长度：\n```\nimport java.util.Scanner;\npublic class Main {\n    public static void main(String[] args) {\n        Scanner scanner = new Scanner(System.in);\n        System.out.print(\"Enter a string: \");\n        String input = scanner.nextLine();\n        int length = input.length();\n        System.out.println(\"The length of \" + input + \" is \" + length);\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:30:52');
INSERT INTO `t_chat_message` VALUES ('1622ae37a21b1d7de1277354cc982ed1', 'c41efa5543b0887e06fa263c132b7d79', 'system', NULL, '你是一个高级软件工程师，你需要帮我解答各种技术难题、设计技术方案以及编写代码。你编写的代码必须可以正常运行，而且没有任何 Bug 和其他问题。如果你的回答中用代码，请用 markdown 代码块，并且在代码块中标明使用的编程语言。', 0, 0, 0, NULL, NULL, '2024-04-24 19:03:50');
INSERT INTO `t_chat_message` VALUES ('179ef8ecb5589853d6b08bf42a6c4003', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:36:18');
INSERT INTO `t_chat_message` VALUES ('1e7e63c4529a63b3d095ec51b4861049', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:58:58');
INSERT INTO `t_chat_message` VALUES ('1fcba4a0349b63ff138927428aa38d10', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'f28512882fcda818e9acf00f6c0e039a', ' 是的，今天的天气非常好！你有任何问题需要我的帮助吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:13');
INSERT INTO `t_chat_message` VALUES ('2135d6afd9255aaa605ae083d90ec0f4', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'badcdbd5d66f0fcd42ac9e2d40daf446', ' 当然，这里是两段话的Java代码：\n```\npublic class BubbleSort {\n    public static void main(String[] args) {\n        int[] arr = {5, 2, 8, 1, 7};\n        for (int num : arr) {\n            for (int i = 0; i < num - 1; i++) {\n                if (arr[i] > arr[i + 1]) {\n                    int temp = arr[i];\n                    arr[i] = arr[i + 1];\n                    arr[i + 1] = temp;\n                }\n            }\n        }\n        System.out.println(\"排序后的数组:\");\n        for (int num : arr) {\n            System.out.print(num + \" \");\n        }\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:29:12');
INSERT INTO `t_chat_message` VALUES ('257f1cc570625248afe8c10ddded5f52', 'bd0eff3e9cd30b3f1bc1a66cb8658a5c', 'assistant', 'ef692fca51aec675671e919362fc3f68', ' 的应用程序具有强大的功能，支持各种类型的聊天应用程序，包括智能聊天机器人。该应用程序使用Spring Boot作为其基础，并使用MyBatis-Plus作为数据库连接器。\n\n', 1, 88, 65, '103550eb06ea493723e666207d37d722', 'GPU-4G-7B-CN', '2024-04-24 18:31:34');
INSERT INTO `t_chat_message` VALUES ('2a41f561b5e234f7caae65240b56f6cf', 'c41efa5543b0887e06fa263c132b7d79', 'user', NULL, '请使用Java帮我写一个冒泡排序算法', 0, 18, 0, NULL, NULL, '2024-04-24 19:04:26');
INSERT INTO `t_chat_message` VALUES ('2be08632a9515395aa84e319f8decc0f', 'bd0eff3e9cd30b3f1bc1a66cb8658a5c', 'assistant', '5f42cee29e7c10fb32a53ba612a45cca', ' 我的回答是基于中文的。\n\n', 0, 14, 13, '103550eb06ea493723e666207d37d722', 'GPU-4G-7B-CN', '2024-04-24 18:31:17');
INSERT INTO `t_chat_message` VALUES ('339f470b1800ea85870d8497c439e7b4', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '1133a51b69c881f13129e3a9ba8d2a79', ' 很高兴认识你！有什么我可以帮你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:05');
INSERT INTO `t_chat_message` VALUES ('35d0d5c8cbfc7fa95b32a3b5a77fa749', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '请帮我写一个java排序算法', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:52:02');
INSERT INTO `t_chat_message` VALUES ('360a8a5ba7b1f93a5f50d1b395005cfc', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '179ef8ecb5589853d6b08bf42a6c4003', ' 你好，有什么我可以帮你的吗？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:36:18');
INSERT INTO `t_chat_message` VALUES ('3a9b636b46b28d86a483874b0454d60c', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '87ede439de9e5460037e959649f9e0aa', ' 你好！我是一款智能聊天机器人，可以帮你解答问题、提供信息和陪伴你。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:21:51');
INSERT INTO `t_chat_message` VALUES ('3b8e51caf30db5aefeed456e4520c551', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '请把代码给我', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:05:15');
INSERT INTO `t_chat_message` VALUES ('3cff8d9ecf9c046753bd6110e3483c66', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:25:19');
INSERT INTO `t_chat_message` VALUES ('3fd5c2a5c169c28ee652bf08e2287115', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '0463447007d5f34be680dca594a2f4ae', ' 当然，这里是一段简单的Java代码，它将提示用户输入一个数字并返回该数字的平方：\n```\nimport java.util.Scanner;\npublic class Square {\n    public static void main(String[] args) {\n        Scanner scanner = new Scanner(System.in);\n        System.out.print(\"Enter a number: \");\n        int num = scanner.nextInt();\n        System.out.println(\"The square of \" + num + \" is \" + num * num);\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:42:50');
INSERT INTO `t_chat_message` VALUES ('414ee8e5749f15aee71f62e799747f6e', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好，请求为我写两段话', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:28:30');
INSERT INTO `t_chat_message` VALUES ('4232d3778b5664a054fad7f041fe9206', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', '920361d3c1ddbd315f65f3ba93994e2e', ' 你好！有什么我可以帮助你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:46:02');
INSERT INTO `t_chat_message` VALUES ('4429a70d88cb1aad5e950cb5baa4b797', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '47d2599078c934d6b0b729adb8f1fcf9', ' 我可以回答问题，提供信息，并帮助解决问题。\n\n', 0, 24, 21, '1', 'RWKV', '2024-04-24 16:29:21');
INSERT INTO `t_chat_message` VALUES ('4489aa0d7b3051ba1ca19c0ff1c30172', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '写一段代码', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:29:42');
INSERT INTO `t_chat_message` VALUES ('45444da9cbf1e76c362d7402906222c1', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '048125b0b68fd3aa154e52604e3cadb0', ' 你好！有什么我可以帮你的？\n\n', 1, 16, 15, '1', 'RWKV', '2024-04-24 16:08:02');
INSERT INTO `t_chat_message` VALUES ('46bdb8a4383c214a4eaa674f8eba4863', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:29:18');
INSERT INTO `t_chat_message` VALUES ('47d2599078c934d6b0b729adb8f1fcf9', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', 0, 2, 0, NULL, NULL, '2024-04-24 16:29:21');
INSERT INTO `t_chat_message` VALUES ('4a10349b15a3cd7eefebc13f3586d185', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:47:22');
INSERT INTO `t_chat_message` VALUES ('4b88d72c6548bc441bd1a73a0bf68058', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:26:45');
INSERT INTO `t_chat_message` VALUES ('4db2037da375d17b8e72821672b0c223', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '1e7e63c4529a63b3d095ec51b4861049', ' 很高兴能帮到你！有什么我可以帮你的吗？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:58:58');
INSERT INTO `t_chat_message` VALUES ('546f742d1cfafc914ef994bf8f88c7ef', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '请使用Java', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:24:38');
INSERT INTO `t_chat_message` VALUES ('5b7682036e1bd85198697f183f2cdf01', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '8613a1cbe69459c04544e209bc63d799', ' 我是一款智能聊天机器人，旨在帮助和回答各种问题。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-24 15:30:25');
INSERT INTO `t_chat_message` VALUES ('5dabcf4a5a5377b2a60504b237445e05', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', 'c0acfeb637ec65488f0931e3a2cb912a', ' 你好！有什么我可以帮助你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:45:50');
INSERT INTO `t_chat_message` VALUES ('5e39018c833045806291e922dfd2efde', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好啊', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:31:41');
INSERT INTO `t_chat_message` VALUES ('5f42cee29e7c10fb32a53ba612a45cca', 'bd0eff3e9cd30b3f1bc1a66cb8658a5c', 'user', NULL, 'The intelligent chatbot is a website that supports intelligent question-answering, providing HTTP interfaces for applications that need to connect to intelligent chatbots, as well as offering a visual web page for ordinary users to utilize.\nIn terms of technical selection, the backend employs the Spring Boot framework, leveraging its features of automatic configuration and simplified deployment, coupled with the MyBatis-Plus persistence layer framework, significantly enhancing development efficiency. The fr', 0, 512, 0, NULL, NULL, '2024-04-24 18:31:17');
INSERT INTO `t_chat_message` VALUES ('6096b11e1c12c44f7c61c864a4cce4e3', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '622147bdc328e0ef7dd75fdb160937d7', ' 我是一款智能聊天机器人，旨在回答各种问题并提供帮助。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:58:16');
INSERT INTO `t_chat_message` VALUES ('622147bdc328e0ef7dd75fdb160937d7', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:58:16');
INSERT INTO `t_chat_message` VALUES ('623deed4bc82261601d831cf8ac1c961', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', '4a10349b15a3cd7eefebc13f3586d185', ' 你好！有什么我可以帮助你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:47:22');
INSERT INTO `t_chat_message` VALUES ('671b5b5f5468cd3f6432107bc342a4f7', 'a2ef3f3de3a05425852bccc1aab27f0c', 'system', NULL, 'You are a helpful assistant. You can help me by answering my questions. You can also ask me questions.', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:31:35');
INSERT INTO `t_chat_message` VALUES ('68ede0c86396dabcbb868aa5e5700454', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '9a33ddc67e7c0159e97b4cde111d1bfa', ' 当然，我很乐意帮你编写冒泡排序算法！请问你需要排序的数组吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:24');
INSERT INTO `t_chat_message` VALUES ('6994621e2f33aad8923dde11f13a5712', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', '9b0443fe1951c7aefc84aade0f93ee32', ' 以下是一个使用C++编写的快速排序算法：\n```c++\n#include <iostream>\n#include <vector>\nusing namespace std;\nvoid quickSort(vector<int>& arr) {\n    if (arr.size() <= 1)\n        return;\n    \n    int pivot = arr[0];\n    int left = 0;\n    int right = arr.size() - 1;\n    \n    while (left < right) {\n        while (left < right && arr[left] >= pivot)\n            left++;\n        \n        while (left < right && arr[right] >= pivot)\n            right--;\n        \n        if (left < right) {\n            arr[left] = arr[right];\n            ++right;\n        }\n    }\n    \n    quickSort(arr, left, pivot - 1);\n    quickSort(arr, pivot + 1, right);\n}\nint main() {\n    vector<int> arr = {10, 5, 8, 3, 7};\n    \n    quickSort(arr);\n    \n    cout << \"Sorted array: \" << endl;\n    for (int i = 0; i < arr.size(); i++)\n        cout << arr[i] << \" \";\n    cout << endl;\n    \n    return 0;\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 10:46:24');
INSERT INTO `t_chat_message` VALUES ('6b178ee7cb4b523b672c10b97200a44b', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:27:13');
INSERT INTO `t_chat_message` VALUES ('6b71e1056c441a7644da6b478ef23183', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'b7e44d34a94245136aa841e002ba0922', ' 我是一款智能聊天机器人，可以帮你解答问题、提供信息和陪伴你。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:19:33');
INSERT INTO `t_chat_message` VALUES ('7318044e2eac0aa1128640845812075b', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', 0, 2, 0, NULL, NULL, '2024-04-24 16:28:15');
INSERT INTO `t_chat_message` VALUES ('733a3c1b14fafb9bf906af76f57aaea9', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:50:12');
INSERT INTO `t_chat_message` VALUES ('7770dfaabd13f967ef53c925ad04a870', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '我还要C++的排序算法', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:54:54');
INSERT INTO `t_chat_message` VALUES ('799c7aa93f0506044244009158edf019', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '是的', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:33');
INSERT INTO `t_chat_message` VALUES ('7af49bc93a242bb4fea471af56722c7e', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', 'e91d9f53c9f6144d40c6a7add81255cc', ' 你好！有什么我可以帮助你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:18:45');
INSERT INTO `t_chat_message` VALUES ('7bd0cdeb096b193345c436d8239e6ec4', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '4489aa0d7b3051ba1ca19c0ff1c30172', ' 当然，这里是一段简单的Java代码，它将提示用户输入一个数字并返回该数字的平方：\n```\nimport java.util.Scanner;\npublic class Square {\n    public static void main(String[] args) {\n        Scanner scanner = new Scanner(System.in);\n        System.out.print(\"Enter a number: \");\n        int num = scanner.nextInt();\n        System.out.println(\"The square of \" + num + \" is \" + num * num);\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:29:42');
INSERT INTO `t_chat_message` VALUES ('7e51785d0b28173177d745ee7977de48', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '3cff8d9ecf9c046753bd6110e3483c66', ' 你好，我是一款智能聊天机器人，旨在帮助和回答各种问题。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:25:19');
INSERT INTO `t_chat_message` VALUES ('7ebf4388fa4fbbaf47c11b081fc21507', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:56:46');
INSERT INTO `t_chat_message` VALUES ('7f65047bcb84e8c6ceb93896d3939c85', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'e58a13aaeeb5dfafa8c59eb957431648', ' 当然，我可以帮你编写冒泡排序。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:24:10');
INSERT INTO `t_chat_message` VALUES ('8099e8fac4fbd6c4895a0ca79942d6f3', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, '你是谁？', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:47:33');
INSERT INTO `t_chat_message` VALUES ('82f7e883fbc4bfbd37dfc35f6af3673d', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '9479d91921641bae01b964318bc94e92', ' 很高兴能帮到你！你有什么需要帮助的吗？\n\n', 0, 22, 25, '1', 'RWKV', '2024-04-24 17:04:01');
INSERT INTO `t_chat_message` VALUES ('8500280f6ef86c913419fd3798a92016', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '0d98a0da607f985ebf154773b10b91c2', ' 我是一款智能聊天机器人，旨在帮助和回答各种问题。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:00:48');
INSERT INTO `t_chat_message` VALUES ('8613a1cbe69459c04544e209bc63d799', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-24 15:30:25');
INSERT INTO `t_chat_message` VALUES ('87ede439de9e5460037e959649f9e0aa', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:21:51');
INSERT INTO `t_chat_message` VALUES ('8a700f47c723209d9c2763122b3ef4c0', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-24 09:15:40');
INSERT INTO `t_chat_message` VALUES ('8bbc823e68da0b43b9e642d149789aaf', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '1471a4fb6fffc28825161e6e8983d51d', ' 是的，我可以帮你编写一个冒泡排序算法！你需要排序的数组吗？\n\n', 1, 32, 27, '1', 'RWKV', '2024-04-24 17:57:18');
INSERT INTO `t_chat_message` VALUES ('920361d3c1ddbd315f65f3ba93994e2e', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, '你好？', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:46:02');
INSERT INTO `t_chat_message` VALUES ('932369ec5dd2f51aef3c6293aaab0bda', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'c693d80b68f9175d18829c6a6cd6ac08', ' 很高兴能帮到你！', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:17:09');
INSERT INTO `t_chat_message` VALUES ('9363c954393c2fdebbcc4a92646770bf', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '546f742d1cfafc914ef994bf8f88c7ef', ' 当然，这里是冒泡排序的Java代码：\n```\npublic class BubbleSort {\n    public static void main(String[] args) {\n        int[] arr = {5, 2, 8, 1, 7};\n        for (int i = 0; i < arr.length - 1; i++) {\n            for (int j = 0; j < arr.length - 1 - i; j++) {\n                if (arr[j] > arr[j + 1]) {\n                    int temp = arr[j];\n                    arr[j] = arr[j + 1];\n                    arr[j + 1] = temp;\n                }\n            }\n        }\n        System.out.println(\"排序后的数组:\");\n        for (int num : arr) {\n            System.out.print(num + \" \");\n        }\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:24:38');
INSERT INTO `t_chat_message` VALUES ('9479d91921641bae01b964318bc94e92', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好啊', 0, 3, 0, NULL, NULL, '2024-04-24 17:04:01');
INSERT INTO `t_chat_message` VALUES ('9616bacab680db558eebb24fdc2da9fa', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', 'f7c4a0b882e40d15017ef595d615fa74', ' 好的，以下是一个使用Java编写快速排序算法的示例代码：\n```java\npublic class QuickSort {\n    public static void main(String[] args) {\n        int[] arr = {10, 5, 8, 3, 7};\n        quickSort(arr);\n        System.out.println(\"Sorted array: \" + Arrays.toString(arr));\n    }\n    \n    public static void quickSort(int[] arr) {\n        int left = 0;\n        int right = arr.length - 1;\n        \n        while (left <= right) {\n            while (left < right && arr[right] > arr[left])\n                right--;\n            \n            if (left < right)\n                swap(arr, left, right);\n            \n            left++;\n            right--;\n        }\n        \n        printArray(arr);\n    }\n    \n    public static void swap(int[] arr, int i, int j) {\n        int temp = arr[i];\n        arr[i] = arr[j];\n        arr[j] = temp;\n    }\n    \n    public static void swap(int[] array1, int i1, int j1) {\n        for (int k = 0; k < array1.length; k++)\n            if (k != i && k != j)\n                swapArray(array1, i++, j--);\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-19 14:47:11');
INSERT INTO `t_chat_message` VALUES ('9a33ddc67e7c0159e97b4cde111d1bfa', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '请帮我写一个冒泡排序算法', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:24');
INSERT INTO `t_chat_message` VALUES ('9b0443fe1951c7aefc84aade0f93ee32', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, 'C++的呢？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 10:46:24');
INSERT INTO `t_chat_message` VALUES ('9c3fa9a6a3d6ebfbc684c50137fd6115', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-24 11:34:16');
INSERT INTO `t_chat_message` VALUES ('9ff12c26e99c7949027556bc093a92ba', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'e760f767fd87f4ae6d10e0ca86a2a7ff', ' 很高兴能帮到你！有什么我可以帮你的吗？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:59:00');
INSERT INTO `t_chat_message` VALUES ('a146eba3f2294f03761af9218d06e324', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '请使用Java帮我写一个冒泡排序算法', 0, 18, 0, NULL, NULL, '2024-04-24 17:05:09');
INSERT INTO `t_chat_message` VALUES ('a17f9bd58ebc4b224db9b89ffc357c11', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你是谁？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:23:55');
INSERT INTO `t_chat_message` VALUES ('a2748fd142f3229abb89798a1a63dab0', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:14:29');
INSERT INTO `t_chat_message` VALUES ('a2df79e3edb1709d5b12a1d1bfceb80e', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '058228c7819d9d48cace5712914efd66', ' 你好，有什么我可以帮你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:54:14');
INSERT INTO `t_chat_message` VALUES ('a6b14b724501ec1d928b76262be5c531', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:00:41');
INSERT INTO `t_chat_message` VALUES ('a77cc24f4ab7f77c7b242f5aff7af783', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', 'a146eba3f2294f03761af9218d06e324', ' 当然，我可以帮你编写一个冒泡排序算法！请问你需要排序的数组吗？\n\n', 1, 34, 29, '1', 'RWKV', '2024-04-24 17:05:09');
INSERT INTO `t_chat_message` VALUES ('b6ebd8f2c8b550ecbd343b3a6bbb033a', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'a17f9bd58ebc4b224db9b89ffc357c11', ' 我是一个AI，由OpenAI训练而成。我的目的是提供帮助和信息，而不是讨论我的起源。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:23:55');
INSERT INTO `t_chat_message` VALUES ('b7e44d34a94245136aa841e002ba0922', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你是谁？你能帮我干什么？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:19:33');
INSERT INTO `t_chat_message` VALUES ('b833e060a910cc63b4afec749970b014', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '再来一段', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:30:52');
INSERT INTO `t_chat_message` VALUES ('b85047692456d9d3f1f7367013440e10', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '35d0d5c8cbfc7fa95b32a3b5a77fa749', ' 当然，这里是一段简单的Java排序算法的代码：\n```\npublic class Sort {\n    public static void main(String[] args) {\n        int[] arr = {5, 2, 8, 1};\n        Arrays.sort(arr);\n        for (int i = 0; i < arr.length; i++) {\n            System.out.print(arr[i] + \" \");\n        }\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:52:02');
INSERT INTO `t_chat_message` VALUES ('b8e88b5f1fcb50d531c53676ceadb39b', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '7770dfaabd13f967ef53c925ad04a870', ' 当然，这里是一段简单的C++排序算法：\n```\n#include <iostream>\nusing namespace std;\nint main() {\n    int arr[] = {5, 2, 8, 1};\n    int n = arr.length;\n    for (int i = 0; i < n - 1; i++) {\n        for (int j = 0; j < n - i - 1; j++) {\n            if (arr[j] > arr[j + 1]) {\n                int temp = arr[j];\n                arr[j] = arr[j + 1];\n                arr[j + 1] = temp;\n            }\n        }\n    }\n    cout << \"排序后的数组: \";\n    for (int i = 0; i < n; i++) {\n        cout << arr[i] << \" \";\n    }\n    cout << endl;\n    return 0;\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:54:54');
INSERT INTO `t_chat_message` VALUES ('b8f4adabb342f898559dbfc8d7f9f3fe', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '6b178ee7cb4b523b672c10b97200a44b', ' 我是一款智能聊天机器人，可以帮你解答问题、提供信息和陪伴你。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:27:13');
INSERT INTO `t_chat_message` VALUES ('b9fb5ae5f4188364f1c33334800ceaec', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'f2d7bbb5a79006df797e43f754478126', ' 你好，有什么我可以帮你的吗？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:51:04');
INSERT INTO `t_chat_message` VALUES ('badcdbd5d66f0fcd42ac9e2d40daf446', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好，请求为我写两段话', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:29:12');
INSERT INTO `t_chat_message` VALUES ('be38c3c5c796c9276b979d4c744f6843', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '7ebf4388fa4fbbaf47c11b081fc21507', ' 你好，有什么我可以帮你的吗？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:56:46');
INSERT INTO `t_chat_message` VALUES ('bf56917e78cecb81256fd0d14717468a', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '9c3fa9a6a3d6ebfbc684c50137fd6115', ' 我是一款智能聊天机器人，旨在帮助和回答各种问题。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-24 11:34:16');
INSERT INTO `t_chat_message` VALUES ('c0acfeb637ec65488f0931e3a2cb912a', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:45:50');
INSERT INTO `t_chat_message` VALUES ('c235974f281f69c203f33663d7323f0b', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'd206902f7014b754e827b52ccc7c9ef2', ' 当然，我很乐意帮你编写一个冒泡排序算法！请问你需要排序的数组吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:50');
INSERT INTO `t_chat_message` VALUES ('c3a8dfec10bac0c8934cd3b36ccc031e', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'a6b14b724501ec1d928b76262be5c531', ' 我是一款智能聊天机器人，旨在帮助和回答各种问题。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:00:41');
INSERT INTO `t_chat_message` VALUES ('c58ca363205587657e5b3242615c15b4', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '没有，我不需要什么帮助', 0, 11, 0, NULL, NULL, '2024-04-24 16:08:21');
INSERT INTO `t_chat_message` VALUES ('c693d80b68f9175d18829c6a6cd6ac08', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:17:09');
INSERT INTO `t_chat_message` VALUES ('c86edab3e64e6f7abb57688c6ce78488', '9d9f65dd1a660ad34f99d1098a0164b8', 'system', NULL, '你是一个高级软件工程师，你需要帮我解答各种技术难题、设计技术方案以及编写代码。你编写的代码必须可以正常运行，而且没有任何 Bug 和其他问题。如果你的回答中用代码，请用 markdown 代码块，并且在代码块中标明使用的编程语言。', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:23:44');
INSERT INTO `t_chat_message` VALUES ('cb86f97069378b400f7df96ceb9ad949', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-24 15:09:12');
INSERT INTO `t_chat_message` VALUES ('cc97b982def066ce821149a97a96821b', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'e33a7d9e4feb07594cb2d5aa0fe87c67', ' 当然，这里是一段代码，它将提示用户输入一个字符串并返回该字符串的长度：\n```\nimport java.util.Scanner;\npublic class Main {\n    public static void main(String[] args) {\n        Scanner scanner = new Scanner(System.in);\n        System.out.print(\"Enter a string: \");\n        String input = scanner.nextLine();\n        int length = input.length();\n        System.out.println(\"The length of \" + input + \" is \" + length);\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:43:35');
INSERT INTO `t_chat_message` VALUES ('cda8f9773b016462899c4626faa294b3', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '4b88d72c6548bc441bd1a73a0bf68058', ' 很高兴认识你！有什么需要帮助的吗？', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:26:45');
INSERT INTO `t_chat_message` VALUES ('d11748da053b831b69a0ccb28de5c882', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '3b8e51caf30db5aefeed456e4520c551', ' 当然，这是你需要的Java代码：\n```\npublic class BubbleSort {\n    public static void main(String[] args) {\n        int[] arr = {5, 2, 8, 1};\n        bubbleSort(arr);\n        for (int i = 0; i < arr.length; i++) {\n            System.out.print(arr[i] + \" \");\n        }\n    }\n    public static void bubbleSort(int[] arr) {\n        for (int i = 0; i < arr.length - 1; i++) {\n            for (int j = 0; j < arr.length - 1 - i; j++) {\n                if (arr[j] > arr[j + 1]) {\n                    // swap elements\n                    int temp = arr[j];\n                    arr[j] = arr[j + 1];\n                    arr[j + 1] = temp;\n                }\n            }\n        }\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:05:15');
INSERT INTO `t_chat_message` VALUES ('d1504e40021c14733318c43a18fcc1a7', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'dc7774a7dbc06ff144c2d1d4aec75615', ' 好的，冒泡排序的基本思路是比较相邻的两个元素，如果它们的顺序错误就交换它们。这样一轮下来，最大（或最小）的数会被“浮”到数列的末尾。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:24:20');
INSERT INTO `t_chat_message` VALUES ('d16bae9726a3e80fe78285d529972063', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你好', 0, 2, 0, NULL, NULL, '2024-04-24 16:48:00');
INSERT INTO `t_chat_message` VALUES ('d206902f7014b754e827b52ccc7c9ef2', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '用Java帮我写一个', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:50');
INSERT INTO `t_chat_message` VALUES ('d42511107d72fb63b52c9c77481c4650', 'b2cbea9470f8e3521ca610fa4572c8e5', 'assistant', '8099e8fac4fbd6c4895a0ca79942d6f3', ' 我是一个AI语言模型，可以回答你的问题和提供帮助。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:47:33');
INSERT INTO `t_chat_message` VALUES ('d4c94647b0ef754885179e5872bf32a9', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '414ee8e5749f15aee71f62e799747f6e', ' 当然，这里是两段话的Java代码：\n```\npublic class BubbleSort {\n    public static void main(String[] args) {\n        int[] arr = {5, 2, 8, 1, 7};\n        for (int num : arr) {\n            for (int i = 0; i < num - 1; i++) {\n                if (arr[i] > arr[i + 1]) {\n                    int temp = arr[i];\n                    arr[i] = arr[i + 1];\n                    arr[i + 1] = temp;\n                }\n            }\n        }\n        System.out.println(\"排序后的数组:\");\n        for (int num : arr) {\n            System.out.print(num + \" \");\n        }\n    }\n}\n```\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:28:30');
INSERT INTO `t_chat_message` VALUES ('d621dc3076709db99621d63942e3eb77', 'bd0eff3e9cd30b3f1bc1a66cb8658a5c', 'system', NULL, '你是一个好用的翻译助手。请将我的中文翻译成英文，将所有非中文的翻译成中文。我发给你所有的话都是需要翻译的内容，你只需要回答翻译结果。翻译结果请符合中文的语言习惯。', 0, 0, 0, NULL, NULL, '2024-04-24 18:30:27');
INSERT INTO `t_chat_message` VALUES ('d93dd8f1fb9cb8af395357cfd485a0fc', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '8a700f47c723209d9c2763122b3ef4c0', ' 我是一款智能聊天机器人，旨在帮助和回答各种问题。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-24 09:15:40');
INSERT INTO `t_chat_message` VALUES ('da592f8a8a59b4751bc6516a821e3d70', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '5e39018c833045806291e922dfd2efde', ' 你好！有什么我可以帮你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:31:41');
INSERT INTO `t_chat_message` VALUES ('db281a4310020451392d3ca6ba6a8f6e', 'c41efa5543b0887e06fa263c132b7d79', 'assistant', '2a41f561b5e234f7caae65240b56f6cf', ' 当然，这是冒泡排序的Java代码：\n```java\npublic class BubbleSort {\n    public static void main(String[] args) {\n        int[] arr = {5, 2, 8, 3, 1};\n        bubbleSort(arr);\n        for (int i = 0; i < arr.length; i++) {\n            System.out.print(arr[i] + \" \");\n        }\n    }\n    public static void bubbleSort(int[] arr) {\n        int n = arr.length;\n        for (int i = 0; i < n - 1; i++) {\n            for (int j = 0; j < n - i - 1; j++) {\n                if (arr[j] > arr[j + 1]) {\n                    // swap\n                    int temp = arr[j];\n                    arr[j] = arr[j + 1];\n                    arr[j + 1] = temp;\n                }\n            }\n        }\n    }\n}\n```\n这个代码定义了一个`BubbleSort`类，它包含了冒泡排序的实现。在主函数中，我们创建了一个包含测试数据的整数列表，并使用`bubbleSort`方法对其进行排序。\n我们使用了一个简单的循环来遍历整个列表，并在每次迭代中查找和交换与当前元素不匹配的元素。这有助于确保我们不会发生任何重复的比较或交换。\n最后，我们使用`System.out.println`打印排序后的数组。\n请注意，由于这是一个简单的排序算法，它可能无法处理大型或复杂的数据集。\n\n', 0, 905, 373, '103550eb06ea493723e666207d37d722', 'GPU-4G-7B-CN', '2024-04-24 19:04:26');
INSERT INTO `t_chat_message` VALUES ('dc7774a7dbc06ff144c2d1d4aec75615', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '写吧', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:24:20');
INSERT INTO `t_chat_message` VALUES ('e33a7d9e4feb07594cb2d5aa0fe87c67', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '再来一段', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:43:35');
INSERT INTO `t_chat_message` VALUES ('e3f9cc606eaa398766213011788aac20', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', 'c58ca363205587657e5b3242615c15b4', ' 很抱歉，我无法提供帮助。我是设计用来回答问题和提供信息的。\n\n', 0, 32, 32, '1', 'RWKV', '2024-04-24 16:08:21');
INSERT INTO `t_chat_message` VALUES ('e46d00cdf379773bc900cf07693de982', 'a2ef3f3de3a05425852bccc1aab27f0c', 'user', NULL, '你是谁？', 0, 4, 0, NULL, NULL, '2024-04-24 17:04:29');
INSERT INTO `t_chat_message` VALUES ('e58a13aaeeb5dfafa8c59eb957431648', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '帮我写一个冒泡排序', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:24:10');
INSERT INTO `t_chat_message` VALUES ('e760f767fd87f4ae6d10e0ca86a2a7ff', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:59:00');
INSERT INTO `t_chat_message` VALUES ('e8ed2336c17d62d69735676ea9c309f2', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', '799c7aa93f0506044244009158edf019', ' 好的，我会尽力帮你完成任务。\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:33');
INSERT INTO `t_chat_message` VALUES ('e91d9f53c9f6144d40c6a7add81255cc', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-19 13:18:45');
INSERT INTO `t_chat_message` VALUES ('ec2a2be0101f3ae78724198de3e884b4', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', 'd16bae9726a3e80fe78285d529972063', ' 你的回答很好！我可以帮你解答问题，提供信息，并帮助解决问题。\n\n', 0, 33, 33, '1', 'RWKV', '2024-04-24 16:48:00');
INSERT INTO `t_chat_message` VALUES ('ef692fca51aec675671e919362fc3f68', 'bd0eff3e9cd30b3f1bc1a66cb8658a5c', 'user', NULL, 'The intelligent chatbot is a website that supports intelligent question-answering, providing HTTP interfaces for applications that need to connect to intelligent chatbots, as well as offering a visual web page for ordinary users to utilize.\nIn terms of technical selection, the backend employs the Spring Boot framework, leveraging its features of automatic configuration and simplified deployment, coupled with the MyBatis-Plus persistence layer framework, significantly enhancing development efficiency. The fr', 0, 512, 0, NULL, NULL, '2024-04-24 18:31:34');
INSERT INTO `t_chat_message` VALUES ('f28512882fcda818e9acf00f6c0e039a', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '今天天气真不错呀', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:04:13');
INSERT INTO `t_chat_message` VALUES ('f2d7bbb5a79006df797e43f754478126', '9d9f65dd1a660ad34f99d1098a0164b8', 'user', NULL, '你好', NULL, NULL, NULL, NULL, NULL, '2024-04-23 16:51:04');
INSERT INTO `t_chat_message` VALUES ('f650c2f44adc153798cc00e669468311', '9d9f65dd1a660ad34f99d1098a0164b8', 'assistant', 'a2748fd142f3229abb89798a1a63dab0', ' 你好，我是一款智能聊天机器人，很高兴能帮到你！', NULL, NULL, NULL, NULL, NULL, '2024-04-23 17:14:29');
INSERT INTO `t_chat_message` VALUES ('f75f61a52df08ffcbb8ab92c50273813', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', 'cb86f97069378b400f7df96ceb9ad949', ' 你好！有什么我可以帮你的吗？\n\n', NULL, NULL, NULL, NULL, NULL, '2024-04-24 15:09:13');
INSERT INTO `t_chat_message` VALUES ('f7c4a0b882e40d15017ef595d615fa74', 'b2cbea9470f8e3521ca610fa4572c8e5', 'user', NULL, '请使用Java帮我写一个快速排序算法', NULL, NULL, NULL, NULL, NULL, '2024-04-19 14:47:11');
INSERT INTO `t_chat_message` VALUES ('f83e716ec969d4de2f514961ae9aa058', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '7318044e2eac0aa1128640845812075b', ' 很高兴能帮到你！你需要我做些什么？\n\n', 0, 20, 21, '1', 'RWKV', '2024-04-24 16:28:15');
INSERT INTO `t_chat_message` VALUES ('f95256f027d4eec759c34d2b00ee679c', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', '0255c9dc272b3e83708ecb1b2d6b38e8', ' 当然，我很乐意帮你编写冒泡排序算法。\n\n', 0, 21, 22, '1', 'RWKV', '2024-04-24 16:28:05');
INSERT INTO `t_chat_message` VALUES ('fcf88c5fc142f67a3e2a4afcc127715a', 'a2ef3f3de3a05425852bccc1aab27f0c', 'assistant', 'e46d00cdf379773bc900cf07693de982', ' 我是一款聊天机器人，用于回答各种问题。\n\n', 1, 22, 22, '1', 'RWKV', '2024-04-24 17:04:29');
...
INSERT INTO `t_chat_session` VALUES ('a2ef3f3de3a05425852bccc1aab27f0c', 'faecf96a4a822452df162b566f8f27fd', '1', '测试', '2024-04-23 17:31:35', '2024-04-24 11:34:13');
...
INSERT INTO `t_chat_session` VALUES ('bd0eff3e9cd30b3f1bc1a66cb8658a5c', '9bd17cbf5f8ea20207b3305eef42c1ac', '103550eb06ea493723e666207d37d722', '翻译', '2024-04-24 18:30:27', '2024-04-24 18:30:27');
INSERT INTO `t_chat_session` VALUES ('c41efa5543b0887e06fa263c132b7d79', 'faecf96a4a822452df162b566f8f27fd', '103550eb06ea493723e666207d37d722', '代码编写', '2024-04-24 19:03:50', '2024-04-24 19:03:50');

-- ----------------------------
-- Table structure for t_model_rate
-- ----------------------------
DROP TABLE IF EXISTS `t_model_rate`;
CREATE TABLE `t_model_rate`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主键',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户ID',
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户昵称',
  `model_version_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '模型ID',
  `rate` int(11) NULL DEFAULT 0 COMMENT '评分',
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '评价/反馈',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_user_id`(`user_id`) USING BTREE,
  INDEX `fk_model_version_id`(`model_version_id`) USING BTREE,
  CONSTRAINT `fk_model_version_id` FOREIGN KEY (`model_version_id`) REFERENCES `t_model_version` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_model_rate
-- ----------------------------
INSERT INTO `t_model_rate` VALUES ('62312bfd86dd7ca94aa78df085951488', 'faecf96a4a822452df162b566f8f27fd', '3067836615@qq.com', '1', 2, '一般', '2024-04-24 13:51:09');
INSERT INTO `t_model_rate` VALUES ('916f64ba0e6f1b130c6336980e6bbce4', 'faecf96a4a822452df162b566f8f27fd', '3067836615@qq.com', '1', 5, '非常完美', '2024-04-24 13:48:34');
...
-- ----------------------------
INSERT INTO `t_model_version` VALUES ('1', 'RWKV', '0.0.1', 'http://rwkv.frp.insectmk.top/', '', 1, 0.3, 0, 1, 00000001024, 31983, '2024-02-29 09:44:41', '默认模型');
INSERT INTO `t_model_version` VALUES ('103550eb06ea493723e666207d37d722', 'GPU-4G-7B-CN', '0.0.1', 'http://rwkv.frp.insectmk.top/', NULL, 1, 0.4, 0, 1, 00000001024, 2992, '2024-04-09 16:16:23', 'GPU-4G-7B-CN');
...
INSERT INTO `t_model_version` VALUES ('6c8e08ea4324ef0bbcd13bcf651682ce', 'test', 'sadfsadf', 'http://gpt.frp.insectmk.top/', '', 1, 0.3, 0, 1, 00000001024, 0, '2024-04-10 11:34:59', 'fdsafsdf');
...
INSERT INTO `t_partner` VALUES ('6bea61e6fb930e1feef76b255b452a0e', '9bd17cbf5f8ea20207b3305eef42c1ac', '翻译助手', '你是一个好用的翻译助手。请将我的中文翻译成英文，将所有非中文的翻译成中文。我发给你所有的话都是需要翻译的内容，你只需要回答翻译结果。翻译结果请符合中文的语言习惯。', 'https://pub-45c0b529c25a4d388dfa7cf57f35f8f0.r2.dev/avatar/translator.jpeg', NULL, '2024-04-24 18:30:02');
...
-- ----------------------------
-- Table structure for t_partner_rate
-- ----------------------------
DROP TABLE IF EXISTS `t_partner_rate`;
CREATE TABLE `t_partner_rate`  (
  `id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '主键',
  `user_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户ID',
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '用户昵称',
  `partner_id` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '搭档ID',
  `rate` int(11) NULL DEFAULT 0 COMMENT '评分',
  `comment` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '评价',
  `create_time` datetime NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `fk_partner_rate_user_id`(`user_id`) USING BTREE,
  INDEX `fk_partner_rate_partner_id`(`partner_id`) USING BTREE,
  CONSTRAINT `fk_partner_rate_partner_id` FOREIGN KEY (`partner_id`) REFERENCES `t_partner` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of t_partner_rate
-- ----------------------------
INSERT INTO `t_partner_rate` VALUES ('ad5c286a2a4b54586f1cb578fe555bb2', 'faecf96a4a822452df162b566f8f27fd', '3067836615@qq.com', '1', 5, '特别好用！', '2024-04-24 14:22:06');
INSERT INTO `t_partner_rate` VALUES ('ed454c7cee4a5dcf784b53d1833d1a4c', 'faecf96a4a822452df162b566f8f27fd', '3067836615@qq.com', '1', 5, '非常好用的搭档，推荐！！！', '2024-04-24 14:23:18');
...
CREATE TABLE `t_system`  (
  ...
  `jwt` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'JWT令牌设置',
  `aes` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'AES加密设置',
  `system` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '系统设置',
  `aliyun_oss` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT '阿里云OSS设置',
...
-- Records of t_system
-- ----------------------------
INSERT INTO `t_system` VALUES ('1', NULL, NULL, NULL, NULL, NULL, NULL, DEFAULT);
...
INSERT INTO `t_system_log` VALUES ('05fa92f581b38f58fb3b3380ed46f707', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:17:57');
...
INSERT INTO `t_system_log` VALUES ('1dd4b5350eba7a47f3afbdc1245ce815', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:42:12');
...
INSERT INTO `t_system_log` VALUES ('228430b9ac65cba83d94af435fe2cd5f', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:17:53');
...
INSERT INTO `t_system_log` VALUES ('2b6623d22bc4510b3a65c59813eda9f2', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:18:08');
...
INSERT INTO `t_system_log` VALUES ('303f676405a877dc8a92f92f4359a6c2', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:39:17');
...
INSERT INTO `t_system_log` VALUES ('339187ad6cf8895d374c57126ac0ee2a', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:21:01');
INSERT INTO `t_system_log` VALUES ('339d659715ac0a2cb399d2473f8cae13', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:21:01');
...
INSERT INTO `t_system_log` VALUES ('437ef89224a31aee3b347873f0e7f956', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:18:40');
...
INSERT INTO `t_system_log` VALUES ('4a891b6a672a30ecd6baaf9bc10abd70', '127.0.0.1', '3067836615@qq.com', '错误', '出错了：com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Duplicate entry \'a77cc24f4ab7f77c7b242f5aff7af783\' for key \'PRIMARY\'', '2024-04-24 17:25:14');
INSERT INTO `t_system_log` VALUES ('4e30533405fa9537f29aea86a5e02b7e', '0:0:0:0:0:0:0:1', '未知', '错误', '非法数据：null', '2024-04-19 12:59:26');
INSERT INTO `t_system_log` VALUES ('4ede4562d6da8faa702282556672b42a', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:42:30');
INSERT INTO `t_system_log` VALUES ('4f7bfc4e4bd9aaae30e73993e18c2a10', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:19:02');
INSERT INTO `t_system_log` VALUES ('52526a432e59623bb36a108b489f1172', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:34:58');
...
INSERT INTO `t_system_log` VALUES ('5f98f8d816861fad4eaec69f6e13b009', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:18:05');
INSERT INTO `t_system_log` VALUES ('607edf2145fde7b06dfd7af5a207ce70', '127.0.0.1', '3067836615@qq.com', '信息', '修改密码', '2024-04-24 19:07:52');
INSERT INTO `t_system_log` VALUES ('60c0c24645f29df6875276d43824b212', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:20:58');
INSERT INTO `t_system_log` VALUES ('645a6b5953ee52ee01f64634eed1b45c', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-19 09:09:18');
INSERT INTO `t_system_log` VALUES ('67d6a0dd2b81171ea2b92fa2de974bc4', '127.0.0.1', '3067836615@qq.com', '错误', '出错了：com.mysql.jdbc.exceptions.jdbc4.MySQLIntegrityConstraintViolationException: Duplicate entry \'fcf88c5fc142f67a3e2a4afcc127715a\' for key \'PRIMARY\'', '2024-04-24 17:25:20');
...
INSERT INTO `t_system_log` VALUES ('7dc933bb6d38bd5d1d22a9fd8bcf9ac5', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:18:08');
...
INSERT INTO `t_system_log` VALUES ('999f648e9e93fc994aa9f034913da283', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:34:08');
...
INSERT INTO `t_system_log` VALUES ('aac307e76c9be8102f545def24573769', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:33:05');
...
INSERT INTO `t_system_log` VALUES ('c044420aeec4c9f70acd95d05b91782a', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:38:31');
...
INSERT INTO `t_system_log` VALUES ('d6537b25cc8a04bc184ef12fdcff20c9', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:19:02');
INSERT INTO `t_system_log` VALUES ('d6983b197b27b6b8232e4b9050b77695', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:20:59');
...
INSERT INTO `t_system_log` VALUES ('da15b4daaddb9a163a5bed54236772ec', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:37:20');
...
INSERT INTO `t_system_log` VALUES ('e3275cd0cf7acaa37ba5256a0b59de04', '127.0.0.1', '3067836615@qq.com', '警告', '业务异常：模型不在线', '2024-04-24 11:13:07');
...
INSERT INTO `t_system_log` VALUES ('ec5f879a7c963bc96284a28085228492', '127.0.0.1', '3067836615@qq.com', '错误', '非法数据：null', '2024-04-24 10:32:53');
INSERT INTO `t_system_log` VALUES ('ec7ff2e453b94e1cb9d630a8879f8b45', '127.0.0.1', '未知', '错误', '非法数据：null', '2024-04-24 18:17:57');
...
-- Records of t_user
-- ----------------------------
INSERT INTO `t_user` VALUES ('9bd17cbf5f8ea20207b3305eef42c1ac', '洗心革面好男孩', '&123456InsectMk', '2514378105@qq.com', 'https://insectmk.cn/static/img/head/insectmk.png', '8D2rIxyCejx-45UtcrIVuSNWwhqjw08_CVn5Tvx3u8OOvqKKH8uxNUbvN3fet9Ax', 10, 9922, '2024-04-19 12:25:27', '2024-04-24 18:25:46');
INSERT INTO `t_user` VALUES ('faecf96a4a822452df162b566f8f27fd', 'InsectMk', '3067836615@qq.com', '3067836615@qq.com', 'https://insectmk.cn/static/img/head/insectmk.png', 'b2cbea9470f8e3521ca610fa4572c8e5', 10, 99999994771, '2024-04-19 10:15:18', '2024-04-24 19:07:59');
